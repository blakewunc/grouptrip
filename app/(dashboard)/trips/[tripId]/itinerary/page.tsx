...
export default function ItineraryPage({ params }: { params: Promise<{ tripId: string }> }) {
  ...
  const { items, loading: itineraryLoading, error } = useItinerary(tripId)
    ...
    return (
      <div className="min-h-screen bg-[#F5F1ED] p-6">
        <div className="mx-auto max-w-5xl">
          <p className="text-[#A99985]">Loading itinerary...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-[#A99985]">
              Plan your day-by-day schedule for {trip.title}
            </p>
          </div>
        ...
        {dates.length === 0 ? (
          ...
          <div className="space-y-8">
            {dates.map((date) => (
              <div key={date}>
                <h2 className="mb-4 text-2xl font-bold text-[#252323]">
